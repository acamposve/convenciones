...
<td rowspan="3" valign="top"  >
        ...
        <tr class="tabla_inicio_fin">
	       	<td width="10%"><div align="left">Fecha Noticias </div></td>
	       	<td width="40%"><div align="left">Titulo Noticias </div></td>
	       	<td width="10%"><div align="center">Categoria <br/>Noticias </div></td>
...
<!--			        <td height="15" valign="middle" class="texto_simple"><div align="center"><input type="checkbox" name="checkbox" value="checkbox" /></div></td>
					...
					if($_SESSION["tipo"]!=1)
						{
							...
							if($seguridad->getSeguridad($id_pantalla,$_SESSION["tipo"]))
    							{
									echo '<a href="?url=tablas&amp;tbl=Noticias&amp;accion=ver&amp;id='.$codigo_noticia.'"  Alt="Ver Noticias"><img src="../plantillas/plantilla_admin/images/boton_buscar.gif" width="19" height="17" border="0" Alt="Ver Noticia" /></a>';
								}
						}
					else
						{
					...
					if($_SESSION["tipo"]!=1)
						{
							...
							if($seguridad->getSeguridad($id_pantalla,$_SESSION["tipo"]))
    							{
									echo '<a href="?url=tablas&amp;tbl=Noticias&amp;accion=editar&amp;id='.$codigo_noticia.'" Alt="Editar Noticias"><img src="../plantillas/plantilla_admin/images/boton_editar.gif" width="18" height="17" border="0" Alt="Editar Noticia" /></a>';
								}
						}
					else
						{
					...
					if($_SESSION["tipo"]!=1)
						{
							...
							if($seguridad->getSeguridad($id_pantalla,$_SESSION["tipo"]))
    							{
									echo '<a href="?url=tablas&amp;tbl=Noticias&amp;accion=eliminar&amp;id='.$codigo_noticia.'" Alt="Eliminar Noticias"><img src="../plantillas/plantilla_admin/images/boton_eliminar.gif" width="18" height="17" border="0" Alt="Eliminar Noticia"  /></a>';
								}
						}
					else
						{
