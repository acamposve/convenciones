...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    <td >&nbsp;</td>
    <td rowspan="3" valign="top" ><form name="data" method="post" action="" onsubmit="return validarLocalidad(this)">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        ...
        <tr>
          <td height="16"><label>
          <select name="id_estado" class="textfield" id="id_estado">
        ...
        <tr>
          <td height="24"><label>
            <input name="nombrelocalidad" type="text" class="textfield" id="nombrelocalidad" size="35" />
