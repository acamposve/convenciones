<?
		...
		$page = $_GET['page']; 
		$limit = 20;  
		$var=$localidad->contarLocalidades();
...
<form name="formlocalidad" id="formlocalidad" action="" method="get">
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr class="Color_tabla">
    ...
    <td width="99%" >
		...
		if($_SESSION["tipo"]!=1)
		{
			...
			echo '<a href="?url=tablas&amp;tbl=Localidad&amp;accion=agregar" class=" linkAgregar">Agregar Registro</a>';
			}
			}else{
			echo '<a href="?url=tablas&amp;tbl=Localidad&amp;accion=agregar" class=" linkAgregar">Agregar Registro</a>';
			}
  ...
  <tr class="Color_tabla">
    ...
    <td rowspan="3" valign="top" ><table width="100%" height="190" border="0" cellpadding="0" cellspacing="0" >
            	  <label>
        	  <div style="padding-top:5px"><input type="text" name="filtro" id="filtro" /><input  name="Buscar" type="button" onclick="javascript:formlocalidad.submit()" value="Buscar"  />
        	  </div>
       	    </label>
      <tr class="tabla_inicio_fin">
        <td width="14%" height="24"><div align="center">Activar</div></td>
        <td width="25%"><div align="left">Nombre Localidad </div></td>
        <td width="23%"><div align="left">Nombre Estado </div></td>
        <td width="23%"><div align="left">Pais</div></td>
        <td width="15%"><div align="center">Acciones</div></td>
      </tr>

      <?
	  $var=$localidad->listarLocalidad( $offset, $limit , $filtro);
	  ...
	  while( list( $key, $val) = each($var) ) {
					...
					$nombre_pais=$pais->getId($Id_pais);
					$nombre_pais=$pais->nombre;
					$nombre_estado=$estado->getId($Id_estado);
					$nombre_estado=$estado->nombre;
					
					$filtro = $var[$key][Nombre_localidad];
	  ...
	  ?>
        ...
        <td height="15"><div align="center">
          <label>
            <input type="checkbox" name="checkbox" value="checkbox" onchange="" />
            </label>
        </div></td>
        <td align="center"><div align="left">&nbsp;<? print $Nombre_localidad; ?> </div></td>
        <td><div align="left">&nbsp;<? print $nombre_estado; ?></div></td>
        <td align="center"><div align="left">&nbsp;<? print $nombre_pais; ?></div></td>
        <td align="center">
						<?
		if($_SESSION["tipo"]!=1)
		{
			...
			echo '<a href="?url=tablas&amp;tbl=Localidad&amp;accion=ver&amp;id='.$Id_localidad.'" Alt="Ver Localidad"><img src="../plantillas/plantilla_admin/images/boton_buscar.gif" width="28" height="28" border="0" Alt="Ver" /></a>';
			}
			}else{
			echo '<a href="?url=tablas&amp;tbl=Localidad&amp;accion=ver&amp;id='.$Id_localidad.'" Alt="Ver Localidad"><img src="../plantillas/plantilla_admin/images/boton_buscar.gif" width="28" height="28" border="0" Alt="Ver" /></a>';
			}
		...
		if($_SESSION["tipo"]!=1)
		{
			...
			echo '<a href="?url=tablas&amp;tbl=Localidad&amp;accion=editar&amp;id='.$Id_localidad.'&amp;id_estado='.$Id_estado.'&amp;id_pais='.$Id_pais.'"  Alt="Editar Localidad"><img src="../plantillas/plantilla_admin/images/boton_editar.gif" width="28" height="28" border="0" Alt="Editar" /></a>';
			}
			}else{
			echo '<a href="?url=tablas&amp;tbl=Localidad&amp;accion=editar&amp;id='.$Id_localidad.'&amp;id_estado='.$Id_estado.'&amp;id_pais='. $Id_pais.'"  Alt="Editar Localidad"><img src="../plantillas/plantilla_admin/images/boton_editar.gif" width="28" height="28" border="0" Alt="Editar" /></a>';
			}
		...
		if($_SESSION["tipo"]!=1)
		{
			...
			echo '<a href="?url=tablas&amp;tbl=Localidad&amp;accion=eliminar&amp;id='.$Id_localidad.'&amp;id_estado='.$Id_estado.'&amp;id_pais='.$Id_pais.'"  Alt="Eliminar Localidad"><img src="../plantillas/plantilla_admin/images/boton_eliminar.gif" width="28" height="28" border="0" Alt="Eliminar" /></a>';
			}
			}else{
			echo '<a href="?url=tablas&amp;tbl=Localidad&amp;accion=eliminar&amp;id='.$Id_localidad.'&amp;id_estado='.$Id_estado.'&amp;id_pais='.$Id_pais.'"  Alt="Eliminar Localidad"><img src="../plantillas/plantilla_admin/images/boton_eliminar.gif" width="28" height="28" border="0" Alt="Eliminar" /></a>';
			}
