						...
						if ($Id_categoria2 ==$Id_categoria_original)
							{
								if  ($Id_modulo==25)
									{
?>
          								&nbsp;&nbsp;<a href="#" onclick="abrirVentana()" ><img src="/cccol/plantillas/plantilla_admin/images/arbolPositivo.gif" /> <font class="textMenu"><? print $Nombre_modulo; ?> </font> </a><br />
<?php
									}
								else
									{
?>
		          						&nbsp;&nbsp; <a href="./?url=<? print $desc;?>&amp;tbl=<? print $Nombre_modulo ?>" ><img src="/cccol/plantillas/plantilla_admin/images/arbolPositivo.gif" /> <font class="textMenu"><? print $Nombre_modulo; ?> </font> </a><br />
<? 
									}
							}
					}
...
?>
		...
		<td valign="top"><div id="CollapsiblePanel9"  class="CollapsiblePanelTab"><a href="http://www.asesoresrrhh.com"><img src="/cccol/plantillas/plantilla_admin/images/flecha_.gif" />...Regresar al Home </a></div></td>
</tr>
</table>
