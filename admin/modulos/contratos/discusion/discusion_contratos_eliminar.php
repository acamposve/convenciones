...
<input readonly="" name="representanteMt" type="text"    id="representanteMt" value="<?php print $representante_min_trab ;?>"  /></td>
...
<input readonly="" name="cargoMt" type="text"    id="cargoMt" value="<?php print $cargo_representante_min_trab ;?>"  /></td>
        ...
        <tr>
          ...
          <?php
				...
				?>		<input name="enviar" type="hidden" value="1"/>	</td>
        </tr>
        <tr>
          <td colspan="3" valign="bottom"><label></label>
            <div align="right">Desea eliminar esta discusion &nbsp;&nbsp;&nbsp;<a href="?url=contratos&amp;tbl=Bitacora&amp;accion=eliminar&amp;id=<? print $codigo_bitacora?>&amp;flag=SI"><img src="../plantillas/plantilla_admin/images/boton_si.gif" width="18" height="11" border="0" />&nbsp;</a><a href="?url=contratos&amp;tbl=Discusion de contratos&amp;accion=listar&amp;id=<? print $codigo_articulo; ?>">&nbsp;&nbsp;<img src="../plantillas/plantilla_admin/images/boton_no.gif" width="18" height="11" border="0" /></a></div></td>
        </tr>
      </table>
    </form></td>
  </tr>
