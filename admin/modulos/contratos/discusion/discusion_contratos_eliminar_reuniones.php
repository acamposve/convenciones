      ...
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        ...
        <tr>
          ...
          <td colspan="3" valign="bottom"><input name="enviar" type="hidden" value="1"/>
                    <div align="right">Desea eliminar esta Reunion &nbsp;&nbsp;&nbsp;
                    <a href="?url=contratos&amp;tbl=Bitacora&amp;accion=eliminar_reuniones&amp;id=<? print $codigo_reunion?>&amp;flag=SI&id_bitacora=<? print $codigo_bitacora;?>">
                    <img src="../plantillas/plantilla_admin/images/boton_si.gif" width="18" height="11" border="0" /></a>
                    <a href="?url=contratos&amp;tbl=Bitacora&amp;accion=listar_reuniones&amp;id=<? print $codigo_bitacora; ?>">
