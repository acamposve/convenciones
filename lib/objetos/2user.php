...
function listarUsuarios( $ini , $fin, $filtro) 
	{
		echo "select * from usuarios where Login_usuario like '%".$filtro."%' ORDER BY  Login_usuario,Nombre_usuario ASC   LIMIT ".$ini.", ".$fin."";
		exit;
		include( '../local/configuracion.php' );		
		$data = array();
		$dbconn = $LibSite->openDBConn(0);
		$list_sql  = "select * from usuarios where Login_usuario like '%".$filtro."%' ORDER BY  Login_usuario,Nombre_usuario ASC   LIMIT ".$ini.", ".$fin."";
