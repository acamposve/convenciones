...
$archivo=$_SERVER['DOCUMENT_ROOT']."/cccol/admin/modulos/contratos/discusion/documentos/".$codigo_discusion."/".$pdf;
$archivo_eliminar="modulos/contratos/discusion/documentos/".$codigo_discusion."/".$pdf;
						if(file_exists($archivo)){
						chmod($archivo_eliminar,0777);
						unlink($archivo_eliminar);
						}
