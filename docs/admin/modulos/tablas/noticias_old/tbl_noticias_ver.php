  ...
  <tr class=" Color_tabla">
    ...
    <td rowspan="3" valign="top" ><form name="form1" method="post" action="">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        <tr>
          <td width="50%" >Titulo d ela Noticia: </td>
        ...
        <tr>
          <td colspan="2"><div align="right"><a href="?url=tablas&amp;tbl=Noticias&amp;accion=editar&amp;id=<? print $id;?>"><img src="../plantillas/plantilla_admin/images/boton_editar.gif" width="18" height="17" border="0" alt="Editar"/></a><a href="?url=tablas&amp;tbl=Noticias&amp;accion=eliminar&amp;id=<? print $id;?>"><img src="../plantillas/plantilla_admin/images/boton_eliminar.gif" width="18" height="17" border="0" alt="Eliminar"/></a></div></td>
        </tr>
      </table>
        </form>    </td>
  </tr>
