  ...
  <tr>
    ...
    <td rowspan="3" valign="top" ><form name="data" method="post" action="" onsubmit="return validarEstado(this)">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class= "trTblReg1">
        <tr>
          <td width="59%" height="16">Nombre de la Actividad: </td>
        </tr>
        <tr>
          <td height="28"><label>
        ...
        <tr>
          <td height="16">Descripcion de la Actividad: </td>
        </tr>
        <tr>
          <td height="16">
          <textarea name="descripcion" cols="90" rows="25"  class="mceEditor" id="descripcion"></textarea>
          </td>
        </tr>
        <tr>
