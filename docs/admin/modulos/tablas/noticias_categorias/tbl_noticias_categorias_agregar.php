...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0"  class="Color_tabla">
  ...
  <tr class=" Color_tabla">
    <td >&nbsp;</td>
    <td rowspan="3" valign="top" ><form name="noticias" method="post" action="">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        <tr>
          <td width="100%" >Nombre de la Categoria</td>
        </tr>
        <tr>
          <td  ><input type="text"  name="nombre_categoria" size="50" /></td>
        </tr>
		<tr>
        	<td colspan="2">Descripcion de la Categoria</td>
        </tr>
		<tr>
        	<td height="16" colspan="3" class="texto_simple">
            <textarea name="descrip_categoria" cols="90" rows="25"  class="mceEditor" id="descrip_categoria"></textarea>			</td>
        </tr>
        <tr> 
