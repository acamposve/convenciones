  ...
  <tr>
    ...
    <td rowspan="3" valign="top" ><form name="data" method="post" action="" onsubmit="return validarEstado(this)">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        <tr>
          <td width="9%" height="16">Nombre del Titulo: </td>
        </tr>
        <tr>
          <td height="28"><label>
            <input name="titulo" type="text" class="textfield" id="titulo" size="35" />
          </label></td>
        </tr>
        <tr>
          <td height="16">Descripcion del Titulo : </td>
        </tr>
        <tr>
          <td height="16"><label>
          ...
          <td height="24">
			...
			$var=$categorias_titulos->listarCategoria2();
			 ...
			 while( list( $key, $val) = each($var) ) {
					...
					if ($categoria==$codigo_categoria_titulos){
			?>
