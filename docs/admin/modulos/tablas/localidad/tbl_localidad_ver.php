  ...
  <tr>
    ...
    <td rowspan="3" valign="top" bgcolor="F8EEEE"><form name="form1" method="post" action="">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        ...
        <tr>
          <td height="16">Nombre del Estado: 
        ...
        <tr>
          <td height="22"><span class="Estilo9">&nbsp;&nbsp;<? print $nombreLocalidad;?></span></td>
        </tr>
        <tr>
          <td height="16">&nbsp;</td>
        </tr>
        <tr>
          <td><div align="right"><a href="?url=tablas&amp;tbl=Localidad&amp;accion=editar&amp;id=<? print $id_localidad;?>&amp;id_estado=<? print $id_estado; ?>&amp;id_pais=<? print $id_pais;?>"><img src="../plantillas/plantilla_admin/images/boton_editar.gif" width="28" height="28" border="0" alt="Editar"/></a><a href="?url=tablas&amp;tbl=Localidad&amp;accion=eliminar&amp;id=<? print $id_localidad;?>&amp;id_estado=<? print $id_estado; ?>&amp;id_pais=<? print $id_pais;?>"><img src="../plantillas/plantilla_admin/images/boton_eliminar.gif" width="28" height="28" border="0" alt="Eliminar"/></a></div></td>
        </tr>
      </table>
        </form>    </td>
  </tr>
