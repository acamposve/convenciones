  ...
  <tr>
    ...
    <td rowspan="3" valign="top" ><form name="form1" method="post" action="">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class=" trTblReg1">
        <tr>
          <td width="42%" height="16">Nombre Empresa:</td>
          <td width="53%"><label>  
            <input  size="30" name="nombre" type="text" size="55" class="texto_simple" id="nombre" value="<? print $nombre_empresa ;?> " readonly=""   />
          </label></td>
        </tr>
        <tr>
          <td>Direccion:</td>
        ...
        <tr>
          ...
          <td><select name="id_pais" class="textfield" id="id_pais" onchange="Recargar()" disabled="disabled">
        ...
        <tr>
          <td>Estado:</td>
          <td><select name="id_estado" class="textfield" id="id_estado" onchange="Recargar()" disabled="disabled">
        ...
        <tr>
          ...
          <td><select name="id_localidad" class="textfield" id="select" disabled="disabled">
        ...
        <tr>
          ...
          <td><select name="sector" class="textfield" id="select2" disabled="disabled"  >
        ...
        <tr>
          ...
          <td><select name="tipos" class="textfield" id="select3" disabled="disabled"  >
        ...
        <tr>
          <td>Categoria</td>
          <td><select name="categoria" class="textfield" id="select4" disabled="disabled" >
        ...
        <tr>
          ...
          <td><select name="actividad" class="textfield" id="select5" disabled="disabled">
        ...
        <tr>
        <tr>
          <td colspan="3" valign="bottom"><label></label>            <div align="right"><a href="?url=tablas&amp;tbl=Empresas&amp;accion=editar&amp;id=<? print $id_empresa; ?>"><img src="../plantillas/plantilla_admin/images/boton_editar.gif" width="28" height="28" border="0" ALT="Editar"/></a><a href="?url=tablas&amp;tbl=Empresas&amp;accion=eliminar&amp;id=<? print $id_empresa;?>"><img src="../plantillas/plantilla_admin/images/boton_eliminar.gif" width="28" height="28" border="0" ALT="Eliminar"/></a></div></td>
          </tr>
      </table>
        </form>    </td>
  </tr>
