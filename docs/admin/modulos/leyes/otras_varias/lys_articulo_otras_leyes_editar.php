  ...
  <tr>
    ...
    <td rowspan="3" valign="top" ><form name="data" method="post" action="" onsubmit="return validarEstado(this)">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class=" trTblReg1">
        <tr>
          <td width="99%" height="16">Numero del Art&iacute;culo: </td>
        </tr>
        <tr>
          <td height="16"><label>
            <input name="nro_articulo" type="text" class="textfield" id="nro_articulo" value="<? print $nro_articulo; ?>" size="8" />
          </label></td>
        </tr>
		<tr>
		...
		<tr>
            <td>
            <input name="titulo_articulo" type="text" class="textfield" id="titulo_articulo" value="<? print $titulo_articulo; ?>" size="35" />            </td>
        </tr>
        <tr>
          <td height="16">Texto Completo del Art&iacute;culo: </td>
        </tr>
        <tr>
          <td height="16" colspan="3"><textarea name="articulo_completo" cols="90" rows="25"  class="mceEditor" id="articulo_completo"><? print $texto_completo_articulo;?></textarea></td>
          </tr>
        <tr>
          <td height="16">Resumen del Art&iacute;culo:</td>
        </tr>
        <tr>
          <td height="16" colspan="3"><textarea name="resumen_articulo" cols="90" rows="25"  class="mceEditor" id="resumen_articulo"><? print $resumen_articulo ?></textarea></td>
          </tr>
        <tr>
		...
		<tr>
        	<td><input name="campo_comparativo" type="text" class="textfield" id="campo_comparativo" size="35" value="<? print $campo_comparativo; ?>" /></td>
        </tr>
        <tr>
