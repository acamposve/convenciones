  ...
  <tr>
    ...
    <td rowspan="3" valign="top" ><form name="form1" method="post" action="" enctype="multipart/form-data">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        ...
        <tr  >
          	<td height="100%" colspan="2"><input  size="75" name="nombre_ley" type="text"  id="nombre_ley" value="<? print $nombre_ley;?>" /></td>
        </tr>
        <tr>
          <td height="16" width="50%">Origen 
		  </td>
          <td height="16" width="50%">&nbsp; </td>
        </tr>
        <tr  >
          	<td height="100%" colspan="2"><input  size="75" name="origen" type="text"  id="origen" value="<? print $origen;?>" />
			&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <input name="fecha_publicacion" type="text"  value="<? print $fecha_publicacion_ley;   ?>" />
            ...
            <td><input name="pdf_asociado" type="file"   value="" />            </td>
        </tr>
        <tr>        </tr>
        <tr>
        ...
        <tr>
          <td height="20" colspan="2"><textarea name="descripcion_resumen" cols="90" rows="30"  class="mceEditor" ><? print $descripcion_ley; ?></textarea></td>
        </tr>
