...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <td width="99%" >            <div align="center">   <? print $nombre_empresa;?></div>
	</td>
  </tr>
  <tr>
    <td >&nbsp;</td>
    <td rowspan="3" valign="top" ><form name="form1" method="post" action="" enctype="multipart/form-data">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="  trTblReg1">
        <tr>
          ...
          <td width="53%">Titulo Peticion: </td>
          </tr>
        <tr>
          <td height="16" valign="middle"><input name="nroPeticion" type="text" class="" id="nroPeticion" value="<? print $nro_peticion?>" /></td>
		  <td width="53%"><input name="tituloPeticion" type="text" size="50" id="tituloPeticion" value="<? print $titulo_peticion?>"  /></td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <textarea name="textoPeticion" cols="90" rows="20" id="textoPeticion"  class="mceEditor"><? print $texto_completo_peticion ?></textarea>
          </label></td>
          </tr>
<!--
        <tr>
...
-->
          ...
          <input name="enviar" type="hidden" value="1"/>
            <input name="codigoPeticion" type="hidden" id="codigoPeticion" value="<? print $codigo_peticion?>"/>
