...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <td width="99%" ><div align="center"> <?print $nombre_empresa;?></div></td>
    ...
    <td rowspan="3" valign="top" ><form name="form1" method="post" action="" enctype="multipart/form-data">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        <tr>
          ...
          Nro de Clausula : </td>
          <td width="62%">Titulo Clausula</td>

        </tr>
        <tr>
          <td height="16" valign="middle"><input name="nro_articulo" type="text" class="textfield" id="nro_articulo" size="10" /></td>
          <td valign="middle"><input name="titulo_articulo" type="text" class="textfield" id="titulo_articulo" size="60" /></td>
        ...
        <tr>
          <td height="16" colspan="3"><textarea name="texto_completo" cols="90" rows="25"  class="mceEditor" id="texto_completo"></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="16" colspan="3"><textarea name="resumen_texto" cols="90" rows="25"  class="mceEditor" id="resumen_texto"></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>&nbsp;&nbsp;<input name="campo" type="text" class="textfield" id="campo" size="35" />
