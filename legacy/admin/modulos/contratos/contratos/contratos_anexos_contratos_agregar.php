  ...
  <tr>
    ...
    <td rowspan="3" valign="top" ><form name="form1" method="post" action="" enctype="multipart/form-data">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        ...
        <tr>
          <td height="16" valign="middle"><input name="nombre_anexo" type="text" class="textfield" id="nombre_anexo" size="35" /></td>
          <td valign="middle">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="16" colspan="3"><textarea name="descripcion" cols="90" rows="25"  class="mceEditor" id="descripcion"></textarea></td>
        </tr>
        <tr>
