<?
		$page = $_GET['page']; 
		$limit = 20;  
		$var=$actividades->contarActividades();
...
<form name="formActividad" id="formActividad" action="" method="get">
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="Color_tabla">
  ...
  <tr class="Color_tabla">
	...
	<?
		if($_SESSION["tipo"]!=1)
		{
			...
			echo '<a href="?url=tablas&amp;tbl=Actividades&amp;accion=agregar" class="linkAgregar">Agregar Registro</a>';
			}
			}else{
			echo '<a href="?url=tablas&amp;tbl=Actividades&amp;accion=agregar" class="linkAgregar">Agregar Registro</a>';
			}
  ...
  <tr>
    ...
    <td rowspan="3" valign="top" ><table width="100%" height="190" border="0" cellpadding="0" cellspacing="0" >
     ...
     <label>
        	  <div style="padding-top:5px"><input type="text" name="filtro" id="filtro" /><input  name="Buscar" type="button" onclick="javascript:formActividad.submit()" value="Buscar"  />
        	  </div>
       	    </label>
     
      <tr class="tabla_inicio_fin">
        <td width="14%" height="24"><div align="center">Activar</div></td>
        <td><div align="left">Nombre Actividad</div></td>
        <td width="19%"><div align="center">Acciones</div></td>
      </tr>

	  <?
	  $var=$actividades->listarActividades( $offset, $limit, $filtro );
	  
	  while( list( $key, $val) = each($var) ) {
		            $codigo_actividad = $var[$key][codigo_actividad];
					$nombre_actividad = $var[$key][nombre_actividad];
					$descripcion_actividad = $var[$key][descripcion_actividad];
					
					$filtro = $var[$key][nombre_actividad];
	  ...
	  ?>
        ...
        <td><div align="left">&nbsp;&nbsp;<? print $nombre_actividad; ?></div></td>
        <td align="center">
		<?
				if($_SESSION["tipo"]!=1)
		{
			...
			echo '<a href="?url=tablas&amp;tbl=Actividades&amp;accion=ver&amp;id='.$codigo_actividad.'" Alt="Ver Sector"><img src="../plantillas/plantilla_admin/images/boton_buscar.gif" width="28" height="28" border="0" Alt="Ver" /></a>';
			}
			}else{
			echo '<a href="?url=tablas&amp;tbl=Actividades&amp;accion=ver&amp;id='.$codigo_actividad.'" Alt="Ver Sector"><img src="../plantillas/plantilla_admin/images/boton_buscar.gif" width="28" height="28" border="0" Alt="Ver" /></a>';
			}
			...
			<?		if($_SESSION["tipo"]!=1)
		{
			...
			echo '<a href="?url=tablas&amp;tbl=Actividades&amp;accion=editar&amp;id='.$codigo_actividad.'" Alt="Editar Sector"><img src="../plantillas/plantilla_admin/images/boton_editar.gif" width="28" height="28" border="0" Alt="Editar" /></a>';
			}
			}else{
			echo '<a href="?url=tablas&amp;tbl=Actividades&amp;accion=editar&amp;id='.$codigo_actividad.'" Alt="Editar Sector"><img src="../plantillas/plantilla_admin/images/boton_editar.gif" width="28" height="28" border="0" Alt="Editar" /></a>';
			}
					...
					if($_SESSION["tipo"]!=1)
		{
			...
			echo '<a href="?url=tablas&amp;tbl=Actividades&amp;accion=eliminar&amp;id='.$codigo_actividad.'" Alt="Eliminar Sector"><img src="../plantillas/plantilla_admin/images/boton_eliminar.gif" width="28" height="28" border="0" Alt="Eliminar" /></a>';
			}
			}else{
			echo '<a href="?url=tablas&amp;tbl=Actividades&amp;accion=eliminar&amp;id='.$codigo_actividad.'" Alt="Eliminar Sector"><img src="../plantillas/plantilla_admin/images/boton_eliminar.gif" width="28" height="28" border="0" Alt="Eliminar" /></a>';
			}
...
else
{
	...
	if ($page == 1) // Esta es la primera pag
        ...
        echo "<a href=\"?url=tablas&tbl=Actividades&page=" . ($page - 1) . "\"> Anterior </a>"; 
    ...
    for ($i = 1; $i <= $pager->numPages; $i++) { 
        ...
        if ($i == $pager->page) 
            ...
            echo "<a href=\"?url=tablas&tbl=Actividades&page=$i\"> $i </a>"; 
    } 
	}
    ...
    if ($page == $pager->numPages) // this is the last page - there is no next page 
        ...
        echo "<a href=\"?url=tablas&tbl=Actividades&page=" . ($page + 1) . "\"> Siguiente </a>"; 
}
?>
		</td>
		</tr>
