  ...
  <tr>
    ...
    <td rowspan="3" valign="top" ><form name="form1" method="post" action="">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        <tr>
          <td width="100%">Nombre del Categoria: </td>
        </tr>
        <tr>
          <td><label>
        ...
        <tr>
          <td>Descripcion del Categoria : </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          <td><div align="right"><a href="?url=tablas&amp;tbl=Categorias&amp;accion=editar&amp;id=<? print $id_categoria;?>"><img src="../plantillas/plantilla_admin/images/boton_editar.gif" width="28" height="28" border="0" ALT="Editar"/></a><a href="?url=tablas&amp;tbl=Categorias&amp;accion=eliminar&amp;id=<? print $id_categoria;?>"><img src="../plantillas/plantilla_admin/images/boton_eliminar.gif" width="28" height="28" border="0" ALT="Eliminar"/></a></div></td>
        </tr>
      </table>
        </form>    </td>
    <td >&nbsp;</td>
