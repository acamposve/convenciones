  ...
  <tr>
    ...
    <td rowspan="3" valign="top" ><form name="data" method="post" action="" onsubmit="return validarEstado(this)">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="2" class="trTblReg1">
        <tr>
          <td  height="16" width="50%">Numero del Art&iacute;culo: </td>
          <td>Titulo del Artículo: </td>
		</tr>
        <tr>
          <td ><input name="nro_articulo" type="text" class="textfield" id="nro_articulo" size="8" /></td>
        ...
        <tr>
          <td><select name="titulo_comparativo" class="textfield" id="titulo_comparativo"  >
        ...
        <tr>
 	        <td height="16">Campo Comparativo:</td>
		</tr>
        <tr>
