...
//FUNCION QUE DEVUELVE UN TIPO DE USUARIO POR SU ID
...
//FUNCION ELIMINAR TIPO DE USUARIO
...
//FUNCION LISTAR TIPO USUARIO





function listarTipo( $ini , $fin, $filtro ) {
		...
		$list_sql  =  "select * from tipos_de_usuarios where Nombre_tipo  like '%".$filtro."%' ORDER BY  Nombre_tipo ASC LIMIT ".$ini.", ".$fin."";
...
//FUNCION LISTAR TIPO USUARIO 2

function listarTipo2() {
...
//FUNCION INSERT TIPOS DE USUARIO
...
//FUNCION CONTAR TIPO PARA PAGINADOR
